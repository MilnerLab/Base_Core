    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            gasphase=RotationalBD(
                ...
                D = InverseLength(43.0, Prefix.NANO).to_frequency()),
            droplet=RotationalBD(
            ...
            polarizability=Polarizability(
                aniso = PolarizabilityVolume.from_angstrom3(4.1),
                reference="NIST (CCCBDB) computational database"),
